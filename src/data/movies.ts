...
export const movies: Movie[] = [
  ...
  },
  {
    ...
    description: "Deadpool teams up with Wolverine in an epic adventure that breaks the fourth wall and delivers maximum mayhem.",
    duration: 127,
    rating: 4.3,
    reviewCount: 3892
  },
  {
    ...
    description: "Harry Potter returns to Hogwarts for his second year, where a mysterious monster is petrifying students and dark secrets of the school are revealed.",
    duration: 161,
    rating: 4.4,
    reviewCount: 4156
  },
